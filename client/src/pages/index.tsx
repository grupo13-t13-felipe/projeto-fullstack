...
const InputsRegister = () => {
  return (
    <>
      <InputArea nameInput="Email" margin="10px 0px 20px 0px" placeHolder="Insira seu e-mail" focusBorderColor="#5126EA" />
      <InputArea nameInput="Password" />
      <InputArea nameInput="Username" />
      <InputArea nameInput="Age" />
    </>
  )
}
