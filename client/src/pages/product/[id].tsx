        ...
        <>
            ...
            <Flex direction={['column','column' ,'row']} bg={'blue.400'} justifyContent={'space-between'} alignItems={['center', 'center', '']}>
                <Stack ml={['10px', '10px', '50px', '100px']} mt={'20px'} width={['','60%']} mr={'15px'}  >
                    <Box bg={'grey.0'} display={'flex'} justifyContent={'center'} borderRadius={'base'}>
                        <Image src={testecar.cover_image} width={300} alt={testecar.model} height={250} />
                    </Box>
                    <Stack bg={'grey.0'} display={'flex'} justifyContent={'center'} spacing={6}borderRadius={'base'} px={'20px'}>
                        <Text textAlign={'center'} fontSize={'xl'} fontWeight={'semibold'} mt={'20px'}>{testecar.model}</Text>
                        <HStack justifyContent={'space-between'} >
                            <HStack>
                                <Text bg={'blue.100'} fontSize={'sm'} fontWeight={'medium'} color={'blue.300'}>{testecar.year}</Text>
                                <Text bg={'blue.100'} fontSize={'sm'} fontWeight={'medium'} color={'blue.300'}>{testecar.km} KM</Text>
                            </HStack>
                            <Text fontSize={'md'} fontWeight={'medium'} >R$ {testecar.price}</Text>
                        </HStack>
                        <Box>
                            <Buttons backgroundColor={'blue.300'} color={"grey.0"} valueButton={'Comprar'} margin={'0px 0px 20px 20px'}/>
                        </Box>
                    </Stack>
